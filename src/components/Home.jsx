...
const Home = () => {
  return (
    ...
    className="h-screen w-full bg-gradient-to-b from-black via-black to-yellow-200"> 
        <div className='max-w-screen-lg mx-auto flex flex-col items-center justify-center h-full p-4 pt-12 md:flex-row'>
            <div className='flex flex-col justify-center h-full'>
                <h2 className=' text-4xl sm:text-7xl font-bold  text-white'>
                 i'am Full-stack Developer</h2>
            ...
            <div>
                <img src={adarsh} alt="my profile" className='rounded-2xl mx-auto w-2/3 md:w-full'/>
            </div>
        </div>
    </div>
  )
